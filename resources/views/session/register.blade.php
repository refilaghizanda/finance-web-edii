...
@section('content')
    ...
    <section class="min-vh-100 mb-8">
        <div class="page-header align-items-start min-vh-50 pt-5 pb-11 mx-3 border-radius-lg"
            style="background-image: url('../assets/img/curved-images/curved28.jpg');">
            <span class="mask bg-gradient-dark opacity-5"></span>
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-6 text-center mx-auto">
                        <h1 class="text-white mb-2 mt-5">Welcome!</h1>
                        <p class="text-lead text-white">Please register account with your personal info to access this
                            website.</p>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card z-index-0">
                        ...
                        <div class="card-body">
                            <form role="form text-left" method="POST" action="/register">
                                @csrf
                                {{-- register dengan mengisikan nama --}}
                                <div class="mb-3">
                                ...
                                {{-- register dengan mengisikan email --}}
                                <div class="mb-3">
                                ...
                                {{-- register dengan mengisikan password --}}
                                <div class="mb-3">
                                ...
                                {{-- register harus menyetujui terms and conds --}}
                                ...
                                <div class="text-center">
                                    ...
                                    {{-- button untuk melakukan sign in --}}
                                </div>
